...
| `connect_with_person` | Send a connection request or accept an incoming one, with optional note (defensive rate limit: 8/day, 40/week) | [#407](https://github.com/stickerdaniel/linkedin-mcp-server/issues/407) |
| `get_sent_invitations` | List currently-pending sent connection invitations (LinkedIn auto-withdraws unaccepted invites after ~6 weeks) | working |
